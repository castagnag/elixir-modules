...
We have two sealings in the last rule to take into account the result type given
by the prorgammer and compare them to the one given by the module types.
